...
Временно нельзя в многопоточной обработке создавать новые сущности, и отправлять или читать события (Будет улучшено в следующих версиях) (Будет ошибка в DEBUG)  
