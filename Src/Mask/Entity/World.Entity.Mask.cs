...
namespace FFS.Libraries.StaticEcs {
    ...
    public abstract partial class World<WorldType> {
        ...
        public readonly partial struct Entity {
            ...
            #region BY_RAW_TYPE
            [MethodImpl(AggressiveInlining)]
            public bool HasAllOfMasksByType(Type maskType) {
                return ModuleMasks.Value.GetPool(maskType).Has(this);
            }
            
            [MethodImpl(AggressiveInlining)]
            public void SetMaskByType(Type maskType) {
                ModuleMasks.Value.GetPool(maskType).Set(this);
            }
            
            [MethodImpl(AggressiveInlining)]
            public void DeleteMaskByType(Type maskType) {
                ModuleMasks.Value.GetPool(maskType).Delete(this);
            }
            
            [MethodImpl(AggressiveInlining)]
            public bool TryDeleteMaskByType(Type maskType) {
