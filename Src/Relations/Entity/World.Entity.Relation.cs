...
namespace FFS.Libraries.StaticEcs {
    ...
    public abstract partial class World<WorldType> {
        ...
        public readonly partial struct Entity {
            ...
            public void DeleteLinks<L>(EntityGID link1) where L : struct, IEntityLinksComponent<L> {
            ...
            [MethodImpl(AggressiveInlining)]
            public void DeleteLinks<L>(EntityGID link1, EntityGID link2) where L : struct, IEntityLinksComponent<L> {
                ref var component = ref Components<L>.Value.TryAdd(this);
                ref var multi = ref component.RefValue(ref component).multi;
            ...
            [MethodImpl(AggressiveInlining)]
            public void DeleteLinks<L>(EntityGID link1, EntityGID link2, EntityGID link3) where L : struct, IEntityLinksComponent<L> {
                ref var component = ref Components<L>.Value.TryAdd(this);
                ref var multi = ref component.RefValue(ref component).multi;
                var handler = Context.Value.Get<LinkManyHandlers<L>>().OnDeleteLinkItem;
                if (multi.TryRemoveSwap(link1)) {
            ...
            [MethodImpl(AggressiveInlining)]
            public void DeleteLinks<L>(EntityGID link1, EntityGID link2, EntityGID link3, EntityGID link4) where L : struct, IEntityLinksComponent<L> {
                ref var component = ref Components<L>.Value.TryAdd(this);
                ref var multi = ref component.RefValue(ref component).multi;
                var handler = Context.Value.Get<LinkManyHandlers<L>>().OnDeleteLinkItem;
            ...
            [MethodImpl(AggressiveInlining)]
            public void AddLinks<L>(Entity link1) where L : struct, IEntityLinksComponent<L> {
                ref var component = ref Components<L>.Value.TryAdd(this);
                ref var multi = ref component.RefValue(ref component).multi;
            ...
            [MethodImpl(AggressiveInlining)]
            public void AddLinks<L>(Entity link1, Entity link2) where L : struct, IEntityLinksComponent<L> {
                ref var component = ref Components<L>.Value.TryAdd(this);
                ref var multi = ref component.RefValue(ref component).multi;
                #if DEBUG || FFS_ECS_ENABLE_DEBUG
                if (multi.Contains(link1)) throw new StaticEcsException($"Link {link1} already contains in relations type {typeof(L)}, for {this}");
            ...
            [MethodImpl(AggressiveInlining)]
            public void AddLinks<L>(Entity link1, Entity link2, Entity link3) where L : struct, IEntityLinksComponent<L> {
                ref var component = ref Components<L>.Value.TryAdd(this);
                ref var multi = ref component.RefValue(ref component).multi;
                #if DEBUG || FFS_ECS_ENABLE_DEBUG
                if (multi.Contains(link1)) throw new StaticEcsException($"Link {link1} already contains in relations type {typeof(L)}, for {this}");
            ...
            [MethodImpl(AggressiveInlining)]
            public void AddLinks<L>(Entity link1, Entity link2, Entity link3, Entity link4) where L : struct, IEntityLinksComponent<L> {
                ref var component = ref Components<L>.Value.TryAdd(this);
                ref var multi = ref component.RefValue(ref component).multi;
                #if DEBUG || FFS_ECS_ENABLE_DEBUG
                if (multi.Contains(link1)) throw new StaticEcsException($"Link {link1} already contains in relations type {typeof(L)}, for {this}");
