...
namespace FFS.Libraries.StaticEcs {
    ...
    public readonly struct QueryFunctionRunner<WorldType, C1, C2, C3, C4, P>
        ...
        public bool Search(SearchFunctionWithEntity<WorldType, C1, C2, C3, C4> runner, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode, out World<WorldType>.Entity entity) {
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                if (runner(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx])) {
                                    result = true;
                                    goto EXIT;
                                }
                            }
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run<R>(ref R runner, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode) where R : struct, World<WorldType>.IQueryFunction<C1, C2, C3, C4> {
            ref var c1 = ref World<WorldType>.Components<C1>.Value;
            ref var c2 = ref World<WorldType>.Components<C2>.Value;
            ref var c3 = ref World<WorldType>.Components<C3>.Value;
            ref var c4 = ref World<WorldType>.Components<C4>.Value;
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                runner.Run(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx]);
                            }
                        }
                    } else {
                        do {
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(QueryFunction<C1, C2, C3, C4> runner, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode) {
            ref var c1 = ref World<WorldType>.Components<C1>.Value;
            ref var c2 = ref World<WorldType>.Components<C2>.Value;
            ref var c3 = ref World<WorldType>.Components<C3>.Value;
            ref var c4 = ref World<WorldType>.Components<C4>.Value;
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                World<WorldType>.CurrentQuery.SetCurrentEntity(blockEntity + idx);
                                #endif
                                runner(ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx]);
                            }
                        }
                    } else {
                        do {
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run<D>(ref D data, QueryFunctionWithRefData<D, C1, C2, C3, C4> runner, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode) {
            ref var c1 = ref World<WorldType>.Components<C1>.Value;
            ref var c2 = ref World<WorldType>.Components<C2>.Value;
            ref var c3 = ref World<WorldType>.Components<C3>.Value;
            ref var c4 = ref World<WorldType>.Components<C4>.Value;
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                World<WorldType>.CurrentQuery.SetCurrentEntity(blockEntity + idx);
                                #endif
                                runner(ref data, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx]);
                            }
                        }
                    } else {
                        do {
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(QueryFunctionWithEntity<WorldType, C1, C2, C3, C4> runner, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode) {
            ref var c1 = ref World<WorldType>.Components<C1>.Value;
            ref var c2 = ref World<WorldType>.Components<C2>.Value;
            ref var c3 = ref World<WorldType>.Components<C3>.Value;
            ref var c4 = ref World<WorldType>.Components<C4>.Value;
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                runner(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx]);
                            }
                        }
                    } else {
                        do {
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run<D>(ref D data, QueryFunctionWithRefDataEntity<D, WorldType, C1, C2, C3, C4> runner, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode) {
            ref var c1 = ref World<WorldType>.Components<C1>.Value;
            ref var c2 = ref World<WorldType>.Components<C2>.Value;
            ref var c3 = ref World<WorldType>.Components<C3>.Value;
            ref var c4 = ref World<WorldType>.Components<C4>.Value;
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                runner(ref data, entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx]);
                            }
                        }
                    } else {
                        do {
