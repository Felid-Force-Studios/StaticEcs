...
namespace FFS.Libraries.StaticEcs {
    ...
    internal readonly struct QueryFunctionRunner<WorldType, C1, C2, C3, P>
        ...
        internal bool Search(ReadOnlySpan<ushort> clusters, SearchFunctionWithEntity<WorldType, C1, C2, C3> function, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode, out World<WorldType>.Entity entity) {
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                if (function(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx])) {
                                    result = true;
                                    goto EXIT;
                                }
                            }
        ...
        [MethodImpl(AggressiveInlining)]
        internal void Run<R>(ReadOnlySpan<ushort> clusters, ref R function, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode) where R : struct, World<WorldType>.IQueryFunction<C1, C2, C3> {
            ref var c1 = ref World<WorldType>.Components<C1>.Value;
            ref var c2 = ref World<WorldType>.Components<C2>.Value;
            ref var c3 = ref World<WorldType>.Components<C3>.Value;
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                function.Invoke(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx]);
                            }
                        }
                    } else {
                        do {
        ...
        [MethodImpl(AggressiveInlining)]
        internal void Run(ReadOnlySpan<ushort> clusters, QueryFunction<C1, C2, C3> function, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode) {
            ref var c1 = ref World<WorldType>.Components<C1>.Value;
            ref var c2 = ref World<WorldType>.Components<C2>.Value;
            ref var c3 = ref World<WorldType>.Components<C3>.Value;
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                World<WorldType>.CurrentQuery.SetCurrentEntity(blockEntity + idx);
                                #endif
                                function(ref d1[dIdx], ref d2[dIdx], ref d3[dIdx]);
                            }
                        }
                    } else {
                        do {
        ...
        [MethodImpl(AggressiveInlining)]
        internal void Run<D>(ReadOnlySpan<ushort> clusters, ref D data, QueryFunctionWithRefData<D, C1, C2, C3> function, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode) {
            ref var c1 = ref World<WorldType>.Components<C1>.Value;
            ref var c2 = ref World<WorldType>.Components<C2>.Value;
            ref var c3 = ref World<WorldType>.Components<C3>.Value;
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                World<WorldType>.CurrentQuery.SetCurrentEntity(blockEntity + idx);
                                #endif
                                function(ref data, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx]);
                            }
                        }
                    } else {
                        do {
        ...
        [MethodImpl(AggressiveInlining)]
        internal void Run(ReadOnlySpan<ushort> clusters, QueryFunctionWithEntity<WorldType, C1, C2, C3> function, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode) {
            ref var c1 = ref World<WorldType>.Components<C1>.Value;
            ref var c2 = ref World<WorldType>.Components<C2>.Value;
            ref var c3 = ref World<WorldType>.Components<C3>.Value;
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                function(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx]);
                            }
                        }
                    } else {
                        do {
        ...
        [MethodImpl(AggressiveInlining)]
        internal void Run<D>(ReadOnlySpan<ushort> clusters, ref D data, QueryFunctionWithRefDataEntity<D, WorldType, C1, C2, C3> function, P with, EntityStatusType entities, ComponentStatus components, QueryMode queryMode) {
            ref var c1 = ref World<WorldType>.Components<C1>.Value;
            ref var c2 = ref World<WorldType>.Components<C2>.Value;
            ref var c3 = ref World<WorldType>.Components<C3>.Value;
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMaskRef & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                function(ref data, entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx]);
