        ...
        public void Dispose(P with, EntityStatusType entities, ComponentStatus components, bool strict, QueryData qd) {
            ...
            if (qd.Blocks != null) {
                if (!strict) {
                    ...
                    switch (components) {
                        case ComponentStatus.Enabled: c1.DecQDeleteDisable(); c2.DecQDeleteDisable(); c3.DecQDeleteDisable(); c4.DecQDeleteDisable(); c5.DecQDeleteDisable(); break;
                        case ComponentStatus.Disabled: c1.DecQDeleteEnable(); c2.DecQDeleteEnable(); c3.DecQDeleteEnable(); c4.DecQDeleteEnable(); c5.DecQDeleteEnable(); break;
                    ...
                    switch (components) {
                        case ComponentStatus.Enabled:
                            c1.BlockDeleteDisable(b); c2.BlockDeleteDisable(b); c3.BlockDeleteDisable(b); c4.BlockDeleteDisable(b); c5.BlockDeleteDisable(b);
                            break;
                        case ComponentStatus.Disabled:
                            c1.BlockDeleteEnable(b); c2.BlockDeleteEnable(b); c3.BlockDeleteEnable(b); c4.BlockDeleteEnable(b); c5.BlockDeleteEnable(b);
                            break;
                        default:
                            c1.BlockDelete(b); c2.BlockDelete(b); c3.BlockDelete(b); c4.BlockDelete(b); c5.BlockDelete(b);
                            break;
                    }
                }
