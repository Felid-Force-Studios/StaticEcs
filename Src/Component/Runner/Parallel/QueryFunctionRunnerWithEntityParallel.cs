...
namespace FFS.Libraries.StaticEcs {
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityParallel<WorldType, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where WorldType : struct, IWorldType {
        
        private QueryFunctionWithEntity<WorldType> _runner;
        private Job[] _jobs;
        private uint[] _jobIndexes;

        [MethodImpl(AggressiveInlining)]
        public void Run(ReadOnlySpan<ushort> clusters, QueryFunctionWithEntity<WorldType> runner, P with, EntityStatusType entities, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityParallel<WorldType, C1, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where WorldType : struct, IWorldType {
        
        private QueryFunctionWithEntity<WorldType, C1> _runner;
        private Job[] _jobs;
        private uint[] _jobIndexes;

        [MethodImpl(AggressiveInlining)]
        public void Run(ReadOnlySpan<ushort> clusters, QueryFunctionWithEntity<WorldType, C1> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
            World<WorldType>.AssertNotNestedParallelQuery(World<WorldType>.WorldTypeName);
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityParallel<WorldType, C1, C2, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where WorldType : struct, IWorldType {
        
        private QueryFunctionWithEntity<WorldType, C1, C2> _runner;
        private Job[] _jobs;
        private uint[] _jobIndexes;

        [MethodImpl(AggressiveInlining)]
        public void Run(ReadOnlySpan<ushort> clusters, QueryFunctionWithEntity<WorldType, C1, C2> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
            World<WorldType>.AssertNotNestedParallelQuery(World<WorldType>.WorldTypeName);
            World<WorldType>.AssertRegisteredComponent<C1>(World<WorldType>.Components<C1>.ComponentsTypeName);
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner(entity, ref d1[dIdx], ref d2[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityParallel<WorldType, C1, C2, C3, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        ...
        private QueryFunctionWithEntity<WorldType, C1, C2, C3> _runner;
        private Job[] _jobs;
        private uint[] _jobIndexes;

        [MethodImpl(AggressiveInlining)]
        public void Run(ReadOnlySpan<ushort> clusters, QueryFunctionWithEntity<WorldType, C1, C2, C3> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
            World<WorldType>.AssertNotNestedParallelQuery(World<WorldType>.WorldTypeName);
            World<WorldType>.AssertRegisteredComponent<C1>(World<WorldType>.Components<C1>.ComponentsTypeName);
            World<WorldType>.AssertRegisteredComponent<C2>(World<WorldType>.Components<C2>.ComponentsTypeName);
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityParallel<WorldType, C1, C2, C3, C4, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
        ...
        private QueryFunctionWithEntity<WorldType, C1, C2, C3, C4> _runner;
        private Job[] _jobs;
        private uint[] _jobIndexes;

        [MethodImpl(AggressiveInlining)]
        public void Run(ReadOnlySpan<ushort> clusters, QueryFunctionWithEntity<WorldType, C1, C2, C3, C4> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
            World<WorldType>.AssertNotNestedParallelQuery(World<WorldType>.WorldTypeName);
            World<WorldType>.AssertRegisteredComponent<C1>(World<WorldType>.Components<C1>.ComponentsTypeName);
            World<WorldType>.AssertRegisteredComponent<C2>(World<WorldType>.Components<C2>.ComponentsTypeName);
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityParallel<WorldType, C1, C2, C3, C4, C5, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
        ...
        private QueryFunctionWithEntity<WorldType, C1, C2, C3, C4, C5> _runner;
        private Job[] _jobs;
        private uint[] _jobIndexes;

        [MethodImpl(AggressiveInlining)]
        public void Run(ReadOnlySpan<ushort> clusters, QueryFunctionWithEntity<WorldType, C1, C2, C3, C4, C5> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
            World<WorldType>.AssertNotNestedParallelQuery(World<WorldType>.WorldTypeName);
            World<WorldType>.AssertRegisteredComponent<C1>(World<WorldType>.Components<C1>.ComponentsTypeName);
            World<WorldType>.AssertRegisteredComponent<C2>(World<WorldType>.Components<C2>.ComponentsTypeName);
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx], ref d5[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityParallel<WorldType, C1, C2, C3, C4, C5, C6, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
        ...
        private QueryFunctionWithEntity<WorldType, C1, C2, C3, C4, C5, C6> _runner;
        private Job[] _jobs;
        private uint[] _jobIndexes;

        [MethodImpl(AggressiveInlining)]
        public void Run(ReadOnlySpan<ushort> clusters, QueryFunctionWithEntity<WorldType, C1, C2, C3, C4, C5, C6> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
            World<WorldType>.AssertNotNestedParallelQuery(World<WorldType>.WorldTypeName);
            World<WorldType>.AssertRegisteredComponent<C1>(World<WorldType>.Components<C1>.ComponentsTypeName);
            World<WorldType>.AssertRegisteredComponent<C2>(World<WorldType>.Components<C2>.ComponentsTypeName);
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx], ref d5[dIdx], ref d6[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityParallel<WorldType, C1, C2, C3, C4, C5, C6, C7, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
        ...
        private QueryFunctionWithEntity<WorldType, C1, C2, C3, C4, C5, C6, C7> _runner;
        private Job[] _jobs;
        private uint[] _jobIndexes;

        [MethodImpl(AggressiveInlining)]
        public void Run(ReadOnlySpan<ushort> clusters, QueryFunctionWithEntity<WorldType, C1, C2, C3, C4, C5, C6, C7> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
            World<WorldType>.AssertNotNestedParallelQuery(World<WorldType>.WorldTypeName);
            World<WorldType>.AssertRegisteredComponent<C1>(World<WorldType>.Components<C1>.ComponentsTypeName);
            World<WorldType>.AssertRegisteredComponent<C2>(World<WorldType>.Components<C2>.ComponentsTypeName);
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx], ref d5[dIdx], ref d6[dIdx], ref d7[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityParallel<WorldType, C1, C2, C3, C4, C5, C6, C7, C8, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
        ...
        private QueryFunctionWithEntity<WorldType, C1, C2, C3, C4, C5, C6, C7, C8> _runner;
        private Job[] _jobs;
        private uint[] _jobIndexes;

        [MethodImpl(AggressiveInlining)]
        public void Run(ReadOnlySpan<ushort> clusters, QueryFunctionWithEntity<WorldType, C1, C2, C3, C4, C5, C6, C7, C8> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
            World<WorldType>.AssertNotNestedParallelQuery(World<WorldType>.WorldTypeName);
            World<WorldType>.AssertRegisteredComponent<C1>(World<WorldType>.Components<C1>.ComponentsTypeName);
            World<WorldType>.AssertRegisteredComponent<C2>(World<WorldType>.Components<C2>.ComponentsTypeName);
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx], ref d5[dIdx], ref d6[dIdx], ref d7[dIdx], ref d8[dIdx]);
                            }
                        }
                    } else {
                        do {
