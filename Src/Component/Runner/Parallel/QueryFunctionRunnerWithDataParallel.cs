...
namespace FFS.Libraries.StaticEcs {
    ...
    #endif
    public sealed class QueryFunctionRunnerWithDataParallel<D, WorldType, C1, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where WorldType : struct, IWorldType {
        
        private QueryFunctionWithData<D, C1> _runner;
        ...
        public void Run(D data, QueryFunctionWithData<D, C1> runner, P with, EntityStatusType entitiesParam, ComponentStatus componentsParam, uint minChunkSize, uint workersLimit) {
            _data = data;
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
    #endif
    public sealed class QueryFunctionRunnerWithDataParallel<D, WorldType, C1, C2, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where WorldType : struct, IWorldType {
        
        private QueryFunctionWithData<D, C1, C2> _runner;
        private uint[] _entities;
        private P _with;
        private D _data;
        private EntityStatusType _entitiesParam;
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(D data, QueryFunctionWithData<D, C1, C2> runner, P with, EntityStatusType entitiesParam, ComponentStatus componentsParam, uint minChunkSize, uint workersLimit) {
            _data = data;
            _componentParam = (byte) componentsParam;
            _entitiesParam = entitiesParam;
            _with = with;
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
    #endif
    public sealed class QueryFunctionRunnerWithDataParallel<D, WorldType, C1, C2, C3, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        ...
        private QueryFunctionWithData<D, C1, C2, C3> _runner;
        private uint[] _entities;
        private P _with;
        private D _data;
        private EntityStatusType _entitiesParam;
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(D data, QueryFunctionWithData<D, C1, C2, C3> runner, P with, EntityStatusType entitiesParam, ComponentStatus componentsParam, uint minChunkSize, uint workersLimit) {
            _data = data;
            _componentParam = (byte) componentsParam;
            _entitiesParam = entitiesParam;
            _with = with;
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
    #endif
    public sealed class QueryFunctionRunnerWithDataParallel<D, WorldType, C1, C2, C3, C4, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
        ...
        private QueryFunctionWithData<D, C1, C2, C3, C4> _runner;
        private uint[] _entities;
        private P _with;
        private D _data;
        private EntityStatusType _entitiesParam;
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(D data, QueryFunctionWithData<D, C1, C2, C3, C4> runner, P with, EntityStatusType entitiesParam, ComponentStatus componentsParam, uint minChunkSize, uint workersLimit) {
            _data = data;
            _componentParam = (byte) componentsParam;
            _entitiesParam = entitiesParam;
            _with = with;
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
    #endif
    public sealed class QueryFunctionRunnerWithDataParallel<D, WorldType, C1, C2, C3, C4, C5, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
        ...
        private QueryFunctionWithData<D, C1, C2, C3, C4, C5> _runner;
        private uint[] _entities;
        private P _with;
        private D _data;
        private EntityStatusType _entitiesParam;
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(D data, QueryFunctionWithData<D, C1, C2, C3, C4, C5> runner, P with, EntityStatusType entitiesParam, ComponentStatus componentsParam, uint minChunkSize, uint workersLimit) {
            _data = data;
            _componentParam = (byte) componentsParam;
            _entitiesParam = entitiesParam;
            _with = with;
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
    #endif
    public sealed class QueryFunctionRunnerWithDataParallel<D, WorldType, C1, C2, C3, C4, C5, C6, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
        ...
        private QueryFunctionWithData<D, C1, C2, C3, C4, C5, C6> _runner;
        private uint[] _entities;
        private P _with;
        private D _data;
        private EntityStatusType _entitiesParam;
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(D data, QueryFunctionWithData<D, C1, C2, C3, C4, C5, C6> runner, P with, EntityStatusType entitiesParam, ComponentStatus componentsParam, uint minChunkSize, uint workersLimit) {
            _data = data;
            _componentParam = (byte) componentsParam;
            _entitiesParam = entitiesParam;
            _with = with;
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
    #endif
    public sealed class QueryFunctionRunnerWithDataParallel<D, WorldType, C1, C2, C3, C4, C5, C6, C7, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
        ...
        private QueryFunctionWithData<D, C1, C2, C3, C4, C5, C6, C7> _runner;
        private uint[] _entities;
        private P _with;
        private D _data;
        private EntityStatusType _entitiesParam;
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(D data, QueryFunctionWithData<D, C1, C2, C3, C4, C5, C6, C7> runner, P with, EntityStatusType entitiesParam, ComponentStatus componentsParam, uint minChunkSize, uint workersLimit) {
            _data = data;
            _componentParam = (byte) componentsParam;
            _entitiesParam = entitiesParam;
            _with = with;
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
    #endif
    public sealed class QueryFunctionRunnerWithDataParallel<D, WorldType, C1, C2, C3, C4, C5, C6, C7, C8, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
        ...
        private QueryFunctionWithData<D, C1, C2, C3, C4, C5, C6, C7, C8> _runner;
        private uint[] _entities;
        private P _with;
        private D _data;
        private EntityStatusType _entitiesParam;
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(D data, QueryFunctionWithData<D, C1, C2, C3, C4, C5, C6, C7, C8> runner, P with, EntityStatusType entitiesParam, ComponentStatus componentsParam, uint minChunkSize, uint workersLimit) {
            _data = data;
            _componentParam = (byte) componentsParam;
            _entitiesParam = entitiesParam;
            _with = with;
