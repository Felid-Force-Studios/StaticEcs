...
namespace FFS.Libraries.StaticEcs {
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityFunctionParallel<R, WorldType, P> : AbstractParallelTask
        where R : struct, World<WorldType>.IQueryFunction
        ...
        public void Run(ReadOnlySpan<ushort> clusters, ref R runner, P with, EntityStatusType entities, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityFunctionParallel<R, WorldType, C1, P> : AbstractParallelTask
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(ReadOnlySpan<ushort> clusters, ref R runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if FFS_ECS_DEBUG
            World<WorldType>.AssertNotNestedParallelQuery(World<WorldType>.WorldTypeName);
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner.Invoke(entity, ref d1[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityFunctionParallel<R, WorldType, C1, C2, P> : AbstractParallelTask
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner.Invoke(entity, ref d1[dIdx], ref d2[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityFunctionParallel<R, WorldType, C1, C2, C3, P> : AbstractParallelTask
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner.Invoke(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityFunctionParallel<R, WorldType, C1, C2, C3, C4, P> : AbstractParallelTask
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner.Invoke(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityFunctionParallel<R, WorldType, C1, C2, C3, C4, C5, P> : AbstractParallelTask
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner.Invoke(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx], ref d5[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityFunctionParallel<R, WorldType, C1, C2, C3, C4, C5, C6, P> : AbstractParallelTask
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner.Invoke(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx], ref d5[dIdx], ref d6[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityFunctionParallel<R, WorldType, C1, C2, C3, C4, C5, C6, C7, P> : AbstractParallelTask
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner.Invoke(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx], ref d5[dIdx], ref d6[dIdx], ref d7[dIdx]);
                            }
                        }
                    } else {
                        do {
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerWithEntityFunctionParallel<R, WorldType, C1, C2, C3, C4, C5, C6, C7, C8, P> : AbstractParallelTask
                    ...
                    if (total >= (end - idx) >> 1) {
                        for (; idx < end; idx++) {
                            if ((entitiesMask & (1UL << idx)) > 0) {
                                ...
                                #endif
                                eid = blockEntity + idx;
                                _runner.Invoke(entity, ref d1[dIdx], ref d2[dIdx], ref d3[dIdx], ref d4[dIdx], ref d5[dIdx], ref d6[dIdx], ref d7[dIdx], ref d8[dIdx]);
                            }
                        }
                    } else {
                        do {
