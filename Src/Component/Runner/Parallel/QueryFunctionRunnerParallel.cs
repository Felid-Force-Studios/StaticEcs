...
namespace FFS.Libraries.StaticEcs {
    ...
    public sealed unsafe class QueryFunctionRunnerParallel<WorldType, C1, P> : AbstractParallelTask
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerParallel<WorldType, C1, C2, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerParallel<WorldType, C1, C2, C3, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerParallel<WorldType, C1, C2, C3, C4, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerParallel<WorldType, C1, C2, C3, C4, C5, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerParallel<WorldType, C1, C2, C3, C4, C5, C6, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerParallel<WorldType, C1, C2, C3, C4, C5, C6, C7, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
    ...
    #endif
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    public sealed unsafe class QueryFunctionRunnerParallel<WorldType, C1, C2, C3, C4, C5, C6, C7, C8, P> : AbstractParallelTask
        where P : struct, IQueryMethod
        where C1 : struct, IComponent
        where C2 : struct, IComponent
        where C3 : struct, IComponent
