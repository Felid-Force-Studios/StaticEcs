...
namespace FFS.Libraries.StaticEcs {
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityRefDataParallel<D, WorldType, P> : AbstractParallelTask
        ...
        public void Run(ref D data, QueryFunctionWithRefDataEntity<D, WorldType> runner, P with, EntityStatusType entities, uint minEntitiesPerThread, uint workersLimit) {
            ...
            Prepare(with, entities, out var count);
        ...
        [MethodImpl(AggressiveInlining)]
        public void Prepare(P with, EntityStatusType entities, out uint jobsCount) {
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityRefDataParallel<D, WorldType, C1, P> : AbstractParallelTask
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(ref D data, QueryFunctionWithRefDataEntity<D, WorldType, C1> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if ((DEBUG || FFS_ECS_ENABLE_DEBUG) && !FFS_ECS_DISABLE_DEBUG)
            if (World<WorldType>.MultiThreadActive) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.CurrentQuery.QueryDataCount != 0) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.cfg.ParallelQueryType == ParallelQueryType.Disabled) throw new StaticEcsException("ParallelQueryType = Disabled, change World config");
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityRefDataParallel<D, WorldType, C1, C2, P> : AbstractParallelTask
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(ref D data, QueryFunctionWithRefDataEntity<D, WorldType, C1, C2> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if ((DEBUG || FFS_ECS_ENABLE_DEBUG) && !FFS_ECS_DISABLE_DEBUG)
            if (World<WorldType>.MultiThreadActive) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.CurrentQuery.QueryDataCount != 0) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.cfg.ParallelQueryType == ParallelQueryType.Disabled) throw new StaticEcsException("ParallelQueryType = Disabled, change World config");
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityRefDataParallel<D, WorldType, C1, C2, C3, P> : AbstractParallelTask
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(ref D data, QueryFunctionWithRefDataEntity<D, WorldType, C1, C2, C3> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if ((DEBUG || FFS_ECS_ENABLE_DEBUG) && !FFS_ECS_DISABLE_DEBUG)
            if (World<WorldType>.MultiThreadActive) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.CurrentQuery.QueryDataCount != 0) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.cfg.ParallelQueryType == ParallelQueryType.Disabled) throw new StaticEcsException("ParallelQueryType = Disabled, change World config");
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityRefDataParallel<D, WorldType, C1, C2, C3, C4, P> : AbstractParallelTask
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(ref D data, QueryFunctionWithRefDataEntity<D, WorldType, C1, C2, C3, C4> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if ((DEBUG || FFS_ECS_ENABLE_DEBUG) && !FFS_ECS_DISABLE_DEBUG)
            if (World<WorldType>.MultiThreadActive) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.CurrentQuery.QueryDataCount != 0) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.cfg.ParallelQueryType == ParallelQueryType.Disabled) throw new StaticEcsException("ParallelQueryType = Disabled, change World config");
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityRefDataParallel<D, WorldType, C1, C2, C3, C4, C5, P> : AbstractParallelTask
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(ref D data, QueryFunctionWithRefDataEntity<D, WorldType, C1, C2, C3, C4, C5> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if ((DEBUG || FFS_ECS_ENABLE_DEBUG) && !FFS_ECS_DISABLE_DEBUG)
            if (World<WorldType>.MultiThreadActive) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.CurrentQuery.QueryDataCount != 0) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.cfg.ParallelQueryType == ParallelQueryType.Disabled) throw new StaticEcsException("ParallelQueryType = Disabled, change World config");
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityRefDataParallel<D, WorldType, C1, C2, C3, C4, C5, C6, P> : AbstractParallelTask
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(ref D data, QueryFunctionWithRefDataEntity<D, WorldType, C1, C2, C3, C4, C5, C6> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if ((DEBUG || FFS_ECS_ENABLE_DEBUG) && !FFS_ECS_DISABLE_DEBUG)
            if (World<WorldType>.MultiThreadActive) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.CurrentQuery.QueryDataCount != 0) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.cfg.ParallelQueryType == ParallelQueryType.Disabled) throw new StaticEcsException("ParallelQueryType = Disabled, change World config");
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityRefDataParallel<D, WorldType, C1, C2, C3, C4, C5, C6, C7, P> : AbstractParallelTask
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(ref D data, QueryFunctionWithRefDataEntity<D, WorldType, C1, C2, C3, C4, C5, C6, C7> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if ((DEBUG || FFS_ECS_ENABLE_DEBUG) && !FFS_ECS_DISABLE_DEBUG)
            if (World<WorldType>.MultiThreadActive) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.CurrentQuery.QueryDataCount != 0) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.cfg.ParallelQueryType == ParallelQueryType.Disabled) throw new StaticEcsException("ParallelQueryType = Disabled, change World config");
    ...
    public sealed unsafe class QueryFunctionRunnerWithEntityRefDataParallel<D, WorldType, C1, C2, C3, C4, C5, C6, C7, C8, P> : AbstractParallelTask
        ...
        [MethodImpl(AggressiveInlining)]
        public void Run(ref D data, QueryFunctionWithRefDataEntity<D, WorldType, C1, C2, C3, C4, C5, C6, C7, C8> runner, P with, EntityStatusType entities, ComponentStatus components, uint minEntitiesPerThread, uint workersLimit) {
            #if ((DEBUG || FFS_ECS_ENABLE_DEBUG) && !FFS_ECS_DISABLE_DEBUG)
            if (World<WorldType>.MultiThreadActive) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.CurrentQuery.QueryDataCount != 0) throw new StaticEcsException("Nested query are not available with parallel query");
            if (World<WorldType>.cfg.ParallelQueryType == ParallelQueryType.Disabled) throw new StaticEcsException("ParallelQueryType = Disabled, change World config");
